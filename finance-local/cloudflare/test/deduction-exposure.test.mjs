...
function aggregate(records, scope = {}) {
  const context = vm.createContext({ window: {}, document: { addEventListener() {} }, deductionHistoryProgress: record => ({items:record.installments}), deductionInstallmentAmount: (record,item) => item.amountCents ?? record.amountCents });
