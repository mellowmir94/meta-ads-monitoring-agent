...
Deduction history Excel and PDF exports include the selected plan or EPF contribution month. Every rider statement export reports at most one EPF hold of RM25, regardless of how many EPF schedule installments exist. Insurance exports the exact Finance-entered per-payment amount once, without multiplying it by the two-payment schedule. Fixed Battery Tester plans export one installment: RM50 for the 2-payment plan or RM40 for the 7-payment plan. The Line Item Audit PDF footer remains short and includes only applied deduction categories and Total Deducted.
