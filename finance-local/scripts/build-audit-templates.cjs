...
const moduleCode = ['audit-templates.js', 'deductions.js', 'deduction-exposure.js', 'commission-kpi-comparison.js'].map(name => readFileSync(resolve(root, name), 'utf8').trim()).join('\n');
