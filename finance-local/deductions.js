...
async function deductionHistoryDownloadBatch(groupId, button) {
  ...
  const filters = deductionHistoryFilters(deductionHistoryEnsure()), options = deductionHistoryDownloadOptions(group, filters.typeTimings, deductionToday(), filters.periodStart, filters.periodEnd).filter(option => option.state !== 'upcoming');
...
document.addEventListener('change', event => {
  if (event.target.matches?.('[data-deduction-history-status], [data-deduction-history-type], [data-deduction-history-due], [data-deduction-history-timing], [data-deduction-history-type-timing], [data-deduction-history-month], [data-deduction-history-period-start], [data-deduction-history-period-end]')) return deductionHistoryRender();
